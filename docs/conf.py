...
# -*- coding: utf-8 -*-
#
# rivus_db documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'rivus_db', 'rivus_db Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rivus_db', 'rivus_db Documentation',
     author, 'rivus_db', 'One line description of project.',
     'Miscellaneous'),
]
