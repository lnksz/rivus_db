...
COMMENT ON TABLE public.commodity
    IS 'Null values are allowed because CO2 is also implemented as a commodity';
...
CREATE TABLE public.process (
    ...
    cost_inv_fix integer NOT NULL,
    cost_inv_var integer NOT NULL,
    cost_fix real NOT NULL,
    cost_var real NOT NULL,
    cap_min integer NOT NULL,
