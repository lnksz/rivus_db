...
from run as R
    ...
    JOIN (
        ...
        where R.start_ts BETWEEN '2017-09-23 04:35'::timestamp AND '2017-09-23 06:40'::timestamp
        GROUP BY R.run_id
    ...
    join (
        ...
        where run.start_ts  BETWEEN '2017-09-23 04:35'::timestamp AND '2017-09-23 06:40'::timestamp
...
--where comm_cap_max->>'Heat' is not null and comm_cap_max->>'Heat' <> '0'
    --and comm_cap_max->>'Gas' is null 
order by start_ts DESC
--order by comm_cap_max->'Heat' DESC
;